...
const AboutComp = () => {
	return (
		<div className="w-[90%] mx-auto mt-[7em] bg-[url(/src/assets/images/sxema-background.png)] bg-no-repeat bg-contain bg-right-bottom tr max-xl:text-[0.85em] max-lg:text-[0.75em] max-[930px]:text-[0.65em] max-[830px]:text-[0.6em] max-md:text-[0.5em] max-sm:bg-none max-sm:text-[1em] max-sm:mt-[53em] max-[600px]:text-[0.9em] max-[550px]:text-[0.85em] max-[500px]:text-[0.8em] max-[460px]:text-[0.7em] max-[420px]:text-[0.65em] max-[380px]:text-[0.6em] max-[340px]:text-[0.55em] max-[320px]:text-[0.5em] max-[300px]:text-[0.45em]">
